        ...
        <section class="product-details bg-product-details <?php echo $slug; ?>">
        	<div class="section-content">
						...
						if(get_field('libtech_apparel_images')):
							while(the_repeater_field('libtech_apparel_images')):
								...
								$optionImageThumb = wp_get_attachment_image_src($optionImage, 'thumbnail', false);
	       						...
	       						$optionImageColor = get_sub_field('libtech_apparel_images_color');
				...
				<div class="product-details-right">
						...
						<?php
							...
							if(get_field('libtech_apparel_variations')):
								while(the_repeater_field('libtech_apparel_variations')):
									$productSize = get_sub_field('libtech_apparel_variations_size');
									$productColor = get_sub_field('libtech_apparel_variations_color');
									$productSKU = get_sub_field('libtech_apparel_variations_sku');
									if ($GLOBALS['currency'] == "CAD") {
										$productAvailable = get_sub_field('libtech_apparel_variations_availability_ca');
									} else if ($GLOBALS['currency'] == "EUR") {
										$productAvailable = get_sub_field('libtech_apparel_variations_availability_eur');
									} else {
										$productAvailable = get_sub_field('libtech_apparel_variations_availability_us');
									}
					...
					<p class="holiday-delivery">Free shipping! Orders must be placed by 10:00am PST 12/22 for 12/24 <strong>Holiday Delivery</strong></p>
