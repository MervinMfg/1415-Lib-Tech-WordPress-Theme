<?php
    ...
    if ($host == 'localhost' || $host == 'libtech.dev') {
        ...
        if (is_page_template( 'page-templates/snowboard-finder.php' )) echo '<link href="' . get_template_directory_uri() . '/_/compiled/libtech.snowboardfinder.css" rel="stylesheet" type="text/css" />' . "\n";
        ...
        if (is_page_template( 'page-templates/snowboard-finder.php' )) echo '<link href="' . get_template_directory_uri() . '/_/css/libtech.snowboardfinder.css" rel="stylesheet" type="text/css" />' . "\n";
        include 'header-scripts.php';
    } else {
        ...
        if (is_page_template( 'page-templates/snowboard-finder.php' )) echo '<link href="' . get_template_directory_uri() . '/_/css/libtech.snowboardfinder.min.css?v=' . $GLOBALS['SCRIPT_VERSION'] . '" rel="stylesheet" type="text/css" />' . "\n\t";
