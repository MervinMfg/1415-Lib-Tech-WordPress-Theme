	...
	init: function () {
		...
		if (regionCookie !== null || currencyCookie !== null) {
			...
			if (navigator.cookieEnabled === true) {
				...
				if (
					$('body').hasClass('page-template-page-templatessnowboard-builder-php') ||
					$('body').hasClass('page-template-page-templatessnowboard-builder-share-php') ||
					$('body').hasClass('page-template-page-templatespage-shopping-cart-php') ||
					$('body').hasClass('page-template-page-templatesoverview-products-php') ||
					$('body').hasClass('page-template-snowboard-finder') ||
					$('body').hasClass('single-libtech_snowboards') ||
					$('body').hasClass('single-libtech_nas') ||
					$('body').hasClass('single-libtech_surfboards') ||
