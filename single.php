          ...
          <article <?php post_class() ?> id="post-<?php the_ID(); ?>" itemscope="" itemtype="http://schema.org/BlogPosting">
            <div class="post-wrapper">
            	<div class="entry-header">
            		...
            		<p class="entry-meta">
            			<time itemprop="datePublished" datetime="<?php echo date(DATE_W3C); ?>" pubdate class="updated"><?php the_time('F jS, Y') ?></time> – <fb:comments-count href=<?php the_permalink() ?>></fb:comments-count> Comments
            		</p>
