					...
					<div class="carousel-container">
						<div class="carousel">
							<ul>
								...
								<li class="item"><img src="<?php bloginfo('template_directory'); ?>/_/img/diy/snowboard-top/art/JAMIE-SUN.png" alt="Jamie Sun Top" class="responsive-image board-top-image" data-count="2" data-artist="Jamie" data-desc="Sun Wave" /></li>
								<li class="item"><img src="<?php bloginfo('template_directory'); ?>/_/img/diy/snowboard-top/art/JAMIE-GIRL.png" alt="Jamie Girl Top" class="responsive-image board-top-image" data-count="3" data-artist="Jamie" data-desc="Girl" /></li>
								<li class="item"><img src="<?php bloginfo('template_directory'); ?>/_/img/diy/snowboard-top/art/JAMIE-WAVE.png" alt="Jamie Wave Top" class="responsive-image board-top-image" data-count="4" data-artist="Jamie" data-desc="Wave" /></li>
					...
					<div class="carousel-container">
						<div class="carousel">
							<ul>
								...
								<li class="item"><img src="<?php bloginfo('template_directory'); ?>/_/img/diy/snowboard-base/art/JAMIE-SUN.png" alt="Jamie Sun Base" class="responsive-image board-base-image" data-count="2" data-artist="Jamie" data-desc="Sun Wave" /></li>
								<li class="item"><img src="<?php bloginfo('template_directory'); ?>/_/img/diy/snowboard-base/art/JAMIE-GIRL.png" alt="Jamie Girl Base" class="responsive-image board-base-image" data-count="3" data-artist="Jamie" data-desc="Girl" /></li>
								<li class="item"><img src="<?php bloginfo('template_directory'); ?>/_/img/diy/snowboard-base/art/JAMIE-WAVE.png" alt="Jamie Wave Base" class="responsive-image board-base-image" data-count="4" data-artist="Jamie" data-desc="Wave" /></li>
