...
?>
          ...
          <section class="board-finder bg2">
               <div class="section-content">
                    <div class="finder-step bf-step-1">
                    	<div class="step-1-left">
		                    <h1>Lib Tech Board Finder</h1>
		                    <?php the_content(); ?>
		                    <h3>Sniffing out the right<span>Lib Tech snowboard</span></h3>
		                    <div class="selection-who">
		                    	<h4>What are you?</h4>
		                    	<ul>
		                    		<li class="left"><a href="#" class="bf-button">Guy</a></li>
		                    		<li class="right"><a href="#" class="bf-button">Girl</a></li>
		                    	</ul>
		                    </div>
	                    </div>
	                    <div class="quote-wrapper">
	                    	<blockquote>"The width of your feet best determines how wide of a snowboard that you need."</blockquote>
	                    	<p class="quote-cite">-POS (Lib Tech Kraftsman)</p>
	                    </div>
					</div>
					<div class="finder-step step bf-step-2">
						<div class="quote-wrapper">
	                    	<blockquote>"The width of your feet best determines how wide of a snowboard that you need."</blockquote>
	                    	<p class="quote-cite">-POS (Lib Tech Kraftsman)</p>
	                    </div>
	                    <div class="measurements-wrapper clearfix">
							<div class="selection-measurements-top">
								...
								<div class="height-measurement">
									<h4>Height</h4>
									<div class="height-us">
										<select id="select-height-feet-us" class="select feet">
										...
										<select id="select-height-inches-us" class="select inches">
							...
							</div><!-- .selection-measurements-top -->
							<div class="selection-measurements-bottom">
								...
								<div class="button-next">
									<a href="" class="bf-button">Next</a>
								</div>
							</div><!-- .selection-measurements-bottom -->
						</div><!-- measurements-wrapper -->
					</div><!-- .bf-step-2 -->
					<div class="finder-step bf-step-3">
						<div class="quote-wrapper">
							<blockquote>"The width of your feet best determines how wide of a snowboard that you need."</blockquote>
	                    	<p class="quote-cite">-POS (Lib Tech Kraftsman)</p>
						</div>
						<div class="selection-ability">
							...
							<ul>
								<li class="left"><a href="" class="bf-button">Starter</a></li>
								<li class="center"><a href="" class="bf-button">Middle</a></li>
								<li class="right"><a href="" class="bf-button">Top</a></li>
							</ul>
						</div><!-- .selection-ability -->
						<div class="selection-terrain">
							<h4>What do you ride?</h4>
							<ul>
								<li class="left"><a href="" class="bf-button">Freestyle</a></li>
								<li class="center"><a href="" class="bf-button">Freeride</a></li>
								<li class="right"><a href="" class="bf-button">Powder</a></li>
							</ul>
						</div><!-- .selection-terrain -->
					</div><!-- .bf-step-3 -->
					<div class="finder-step bf-step-4">
						...
						<div class="board-picks">
							...
							<ul class="product-listing snowboards">
								<li class="product-item">
									<a href="#">
										<img src="http://cdn.lib-tech.com/wp-content/uploads/2014/07/2014-2015-Lib-Tech-Jamie-Lynn-fM-funDAMNmental-C3-640x640.png" width="640" height="640" alt="Jamie Lynn FunDamnMental Image" class="product-img" />
										<h5>Jamie Lynn FunDamnMental - </h5>
										<h5 class="board-length">157</h5>
										<div class="price">
											<p class="us-price">
												<span>$559.95</span> USD
											</p>
										</div>
									</a>
								</li>
								<li class="product-item">
									<a href="#">
										<img src="http://cdn.lib-tech.com/wp-content/uploads/2014/07/2014-2015-Lib-Tech-Jamie-Lynn-fM-Deflower-BTX-640x640.png" width="640" height="640" alt="Jamie Lynn FunDamnMental Image" class="product-img" />
										<h5>Jamie Lynn FunDamnMental - </h5>
										<h5 class="board-length">160</h5>
										<div class="price">
											<p class="us-price">
												<span>$696.69</span> USD
											</p>
										</div>
									</a>
								</li>
							</ul>
							<a href="#" class="why-link">Why these boards?</a>
						</div>
					</div><!-- .bf-step-4 -->
					<div class="finder-step bf-step-5">
						<div class="description-image-wrapper">
							<ul class="description-image-list">
								<li class="description-image-item length"></li>
								<!-- <li class="description-image-item width"></li>
								<li class="description-image-item contour"></li> -->
							</ul>
						</div>
						<div class="step-5-content-wrapper">
							<h2>Why these boards?</h2>
							<h3>It is important to get<span>the right snowboard.</span></h3>
							<div class="selection-why">
								<ul>
									<li class="left"><a href="" class="bf-button">Length</a></li>
									<li class="center"><a href="" class="bf-button">Width</a></li>
									<li class="right"><a href="" class="bf-button">Contour</a></li>
								</ul>
							</div>
